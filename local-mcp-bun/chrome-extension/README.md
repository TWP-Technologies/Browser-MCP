...
4. If using a packaged extension zip, use release `v0.4.0` or newer. Earlier zips may fail service-worker registration due to missing module files imported by `background.js`.
